 ...
 *
 * @tagName doc-demo-bare
 * @alpha
 */
export class DocDemoBare extends Component {
	/**
		...
		host => {
			...
			const toolbar = tsx(
				...
				tsx(
					...
					tsx(Option, { value: 'desktop' }, 'Preview'),
					tsx(Option, { value: 'source' }, 'Code'),
				),
			);
