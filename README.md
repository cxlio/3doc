...
| -------------- | ------- | ------- | ------------------------------------ | ---------------------------------------------- |
| @cxl/3doc            | [1.0.0-beta.2](https://npmjs.com/package/@cxl/3doc/v/1.0.0-beta.2) | SEE LICENSE IN LICENSE.md | TypeScript/JavaScript API documentation generator that builds versioned static HTML and JSON with Markdown/JSDoc support, and custom tags. | [Docs](https://cxlio.github.io/docs/@cxl/3doc/1.0.0-beta.2/) |
